...
<report name="Employee List Report Assignment By Ashish"
...
<td> <INPUT TYPE="button"  VALUE=" >>" onClick="last(this.form)">
  ...
  <data>
    <dataSource name="Q_1">
      <select>
      <![CDATA[select *from Ashu.employee;]]>
      </select>
      ...
      <group name="G_EMPNO">
        ...
        <dataItem name="EMPNO" oracleDatatype="number" columnOrder="11"
         ...
         columnFlags="33" defaultLabel="Empno">
          <dataDescriptor expression="Ashu.employee.EMPNO"
           descriptiveExpression="EMPNO" order="1" width="22" scale="-127"/>
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
        <dataItem name="ENAME" datatype="vchar2" columnOrder="12" width="20"
         defaultWidth="100000" defaultHeight="10000" columnFlags="33"
         defaultLabel="Ename">
          <dataDescriptor expression="Ashu.employee.ENAME"
           descriptiveExpression="ENAME" order="2" width="20"/>
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
        <dataItem name="JOB" datatype="vchar2" columnOrder="13" width="20"
         defaultWidth="100000" defaultHeight="10000" columnFlags="33"
         defaultLabel="Job">
          <dataDescriptor expression="Ashu.employee.JOB"
           descriptiveExpression="JOB" order="3" width="20"/>
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
        <dataItem name="MGR" oracleDatatype="number" columnOrder="14"
         width="22" defaultWidth="20000" defaultHeight="10000"
         columnFlags="33" defaultLabel="Mgr">
          <dataDescriptor expression="Ashu.employee.MGR"
           descriptiveExpression="MGR" order="4" width="22" scale="-127"/>
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
        <dataItem name="HIREDATE" datatype="date" oracleDatatype="date"
         ...
         columnFlags="33" defaultLabel="Hiredate">
          <dataDescriptor expression="Ashu.employee.HIREDATE"
        ...
        <dataItem name="SAL" oracleDatatype="number" columnOrder="16"
         ...
         columnFlags="33" defaultLabel="Sal">
          <dataDescriptor expression="Ashu.employee.SAL"
           descriptiveExpression="SAL" order="6" width="22" scale="-127"/>
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
        <dataItem name="DEPTNO" oracleDatatype="number" columnOrder="17"
         width="22" defaultWidth="20000" defaultHeight="10000"
         columnFlags="33" defaultLabel="Deptno">
          <dataDescriptor expression="Ashu.employee.DEPTNO"
           descriptiveExpression="DEPTNO" order="7" width="22" scale="-127"/>
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
      </group>
    </dataSource>
    <summary name="SumSALPerReport" source="SAL" function="sum" width="22"
     scale="-127" reset="report" compute="report" defaultWidth="20000"
      ...
      <frame name="M_G_EMPNO_GRPFR">
        ...
        <repeatingFrame name="R_G_EMPNO" source="G_EMPNO"
         printDirection="down" minWidowRecords="1" columnMode="no">
          ...
          <field name="F_MGR" source="MGR" minWidowLines="1" spacing="0"
           alignment="start">
            <font face="helvetica" size="10"/>
            <geometryInfo x="4.50000" y="0.18750" width="0.31250"
             height="0.18750"/>
            <generalLayout verticalElasticity="expand"/>
          </field>
          <field name="F_HIREDATE" source="HIREDATE" minWidowLines="1"
           spacing="0" alignment="start">
            <font face="helvetica" size="10"/>
            <geometryInfo x="4.81250" y="0.18750" width="1.37500"
             height="0.18750"/>
            <generalLayout verticalElasticity="expand"/>
          </field>
          <field name="F_SAL" source="SAL" minWidowLines="1" spacing="0"
           alignment="start">
            <font face="helvetica" size="10"/>
            <geometryInfo x="6.18750" y="0.18750" width="0.31250"
             height="0.18750"/>
            <generalLayout verticalElasticity="expand"/>
          </field>
        ...
        <frame name="M_G_EMPNO_FTR">
          ...
          <field name="F_SumSALPerReport" source="SumSALPerReport"
           minWidowLines="1" spacing="0" alignment="start">
            ...
            />
            <geometryInfo x="6.18750" y="0.37500" width="0.31250"
             height="0.18750"/>
            <generalLayout verticalElasticity="expand"/>
          </field>
        ...
        <frame name="M_G_EMPNO_HDR">
          ...
          <text name="B_HIREDATE" minWidowLines="1">
            <textSettings spacing="0"/>
            <geometryInfo x="4.81250" y="0.00000" width="1.37500"
             height="0.18750"/>
            <visualSettings fillBackgroundColor="TableHeading"/>
            <textSegment>
              <font face="helvetica" size="10" bold="yes"
          ...
          <text name="B_SAL" minWidowLines="1">
            <textSettings spacing="0"/>
            <geometryInfo x="6.18750" y="0.00000" width="0.31250"
             height="0.18750"/>
            <visualSettings fillBackgroundColor="TableHeading"/>
            <textSegment>
              <font face="helvetica" size="10" bold="yes"
...
DCDCDCDC DCDCDCDC DCDCDCDC DCDCDFDF
      ...
      <text name="B_OR$BODY_SECTION" minWidowLines="1">
        ...
        />
        <textSegment>
          <font face="Courier New" size="10" textColor="gray96"/>
          <string>
          <![CDATA[Employee List]]>
          </string>
        </textSegment>
  ...
  <reportPrivate defaultReportType="tabular" versionFlags2="0"
   templateName="rwgray" sectionTitle="Employee List"/>
  <reportWebSettings>
  <![CDATA[#NULL#]]>
  </reportWebSettings>
</report>
...
<rw:dataArea id="MGEMPNOGRPFR36">
<table class="OraTable">
<caption> Employee List </caption>
 <!-- Header -->
 <thead>
  <tr>
   <th <rw:id id="HBEMPNO36" asArray="no"/> class="OraColumnHeader"> Empno </th>
   <th <rw:id id="HBENAME36" asArray="no"/> class="OraColumnHeader"> Ename </th>
   <th <rw:id id="HBJOB36" asArray="no"/> class="OraColumnHeader"> Job </th>
   <th <rw:id id="HBMGR36" asArray="no"/> class="OraColumnHeader"> Mgr </th>
   <th <rw:id id="HBHIREDATE36" asArray="no"/> class="OraColumnHeader"> Hiredate </th>
   <th <rw:id id="HBSAL36" asArray="no"/> class="OraColumnHeader"> Sal </th>
   <th <rw:id id="HBDEPTNO36" asArray="no"/> class="OraColumnHeader"> Deptno </th>
  </tr>
 </thead>
 <!-- Body -->
 <tbody>
  <rw:foreach id="RGEMPNO361" src="G_EMPNO">
   <tr>
    <td <rw:headers id="HFEMPNO36" src="HBEMPNO36"/> class="OraCellNumber"><rw:field id="FEMPNO36" src="EMPNO" nullValue="&nbsp;"> F_EMPNO </rw:field></td>
    <td <rw:headers id="HFENAME36" src="HBENAME36"/> class="OraCellText"><rw:field id="FENAME36" src="ENAME" nullValue="&nbsp;"> F_ENAME </rw:field></td>
    <td <rw:headers id="HFJOB36" src="HBJOB36"/> class="OraCellText"><rw:field id="FJOB36" src="JOB" nullValue="&nbsp;"> F_JOB </rw:field></td>
    <td <rw:headers id="HFMGR36" src="HBMGR36"/> class="OraCellNumber"><rw:field id="FMGR36" src="MGR" nullValue="&nbsp;"> F_MGR </rw:field></td>
    <td <rw:headers id="HFHIREDATE36" src="HBHIREDATE36"/> class="OraCellText"><rw:field id="FHIREDATE36" src="HIREDATE" nullValue="&nbsp;"> F_HIREDATE </rw:field></td>
    <td <rw:headers id="HFSAL36" src="HBSAL36"/> class="OraCellNumber"><rw:field id="FSAL36" src="SAL" nullValue="&nbsp;"> F_SAL </rw:field></td>
    <td <rw:headers id="HFDEPTNO36" src="HBDEPTNO36"/> class="OraCellNumber"><rw:field id="FDEPTNO36" src="DEPTNO" nullValue="&nbsp;"> F_DEPTNO </rw:field></td>
   </tr>
  </rw:foreach>
 </tbody>
 ...
 <tr>
  ...
  <th class="OraTotalText"> &nbsp; </th>
  <th class="OraTotalText"> &nbsp; </th>
  <td <rw:headers id="HFSumSALPerReport36" src="HBSAL36"/> class="OraTotalNumber">Total: <rw:field id="FSumSALPerReport36" src="SumSALPerReport" nullValue="&nbsp;"> F_SumSALPerReport </rw:field></td>
  <th class="OraTotalText"> &nbsp; </th>
 </tr>
</table>
</rw:dataArea> <!-- id="MGEMPNOGRPFR36" -->
