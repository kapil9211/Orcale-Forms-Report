...
<report name="Employee List Report By Kapil" DTDVersion="9.0.2.0.10">
...
<td> <INPUT TYPE="button"  VALUE=" >>" onClick="last(this.form)">
  ...
  <data>
    <dataSource name="Q_1">
      <select>
      <![CDATA[select *from kapil.employee
]]>
      </select>
      <displayInfo x="1.65002" y="1.00000" width="0.69995" height="0.19995"/>
      <group name="G_E_NO">
        <displayInfo x="1.37732" y="1.94995" width="1.24548" height="1.45605"
        />
        <dataItem name="E_NO" oracleDatatype="number" columnOrder="11"
         width="22" defaultWidth="20000" defaultHeight="10000"
         columnFlags="33" defaultLabel="E No">
          <dataDescriptor expression="kapil.employee.E_NO"
           descriptiveExpression="E_NO" order="1" width="22" scale="-127"/>
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
        <dataItem name="E_NAME" datatype="vchar2" columnOrder="12" width="25"
         defaultWidth="100000" defaultHeight="10000" columnFlags="33"
         defaultLabel="E Name">
          <dataDescriptor expression="kapil.employee.E_NAME"
           descriptiveExpression="E_NAME" order="2" width="25"/>
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
        <dataItem name="E_JOB" datatype="vchar2" columnOrder="13" width="20"
         defaultWidth="100000" defaultHeight="10000" columnFlags="33"
         defaultLabel="E Job">
          <dataDescriptor expression="kapil.employee.E_JOB"
           descriptiveExpression="E_JOB" order="3" width="20"/>
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
        <dataItem name="E_MGR" oracleDatatype="number" columnOrder="14"
         width="22" defaultWidth="20000" defaultHeight="10000"
         columnFlags="33" defaultLabel="E Mgr">
          <dataDescriptor expression="kapil.employee.E_MGR"
           descriptiveExpression="E_MGR" order="4" width="22" scale="-127"/>
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
        <dataItem name="HIREDATE" datatype="date" oracleDatatype="date"
         ...
         columnFlags="33" defaultLabel="Hiredate">
          <dataDescriptor expression="kapil.employee.HIREDATE"
           descriptiveExpression="HIREDATE" order="5" width="9"/>
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
        <dataItem name="E_SALARY" oracleDatatype="number" columnOrder="16"
         width="22" defaultWidth="20000" defaultHeight="10000"
         columnFlags="33" defaultLabel="E Salary">
          <dataDescriptor expression="kapil.employee.E_SALARY"
           descriptiveExpression="E_SALARY" order="6" width="22" scale="-127"
          />
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
        <dataItem name="DEPT_NO" oracleDatatype="number" columnOrder="17"
         width="22" defaultWidth="20000" defaultHeight="10000"
         columnFlags="33" defaultLabel="Dept No">
          <dataDescriptor expression="kapil.employee.DEPT_NO"
           descriptiveExpression="DEPT_NO" order="7" width="22" scale="-127"/>
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
      </group>
    </dataSource>
    <summary name="SumE_SALARYPerReport" source="E_SALARY" function="sum"
     width="22" scale="-127" reset="report" compute="report"
     defaultWidth="20000" defaultHeight="10000" columnFlags="552"
     defaultLabel="Total:">
      <displayInfo x="0.51038" y="1.11462" width="0.79993" height="0.19995"/>
    </summary>
  </data>
  <layout>
  <section name="main">
    <body>
      <frame name="M_G_E_NO_GRPFR">
        <geometryInfo x="0.00000" y="0.00000" width="6.31250" height="0.56250"
        />
        <generalLayout verticalElasticity="variable"/>
        <visualSettings fillPattern="transparent"
         fillBackgroundColor="r100g100b100"/>
        <repeatingFrame name="R_G_E_NO" source="G_E_NO" printDirection="down"
         minWidowRecords="1" columnMode="no">
          ...
          <field name="F_E_NO" source="E_NO" minWidowLines="1" spacing="0"
           alignment="start">
          ...
          <field name="F_E_NAME" source="E_NAME" minWidowLines="1" spacing="0"
           alignment="start">
            <font face="helvetica" size="10"/>
            <geometryInfo x="0.37500" y="0.18750" width="1.50000"
             height="0.18750"/>
            <generalLayout verticalElasticity="expand"/>
          </field>
          <field name="F_E_JOB" source="E_JOB" minWidowLines="1" spacing="0"
           alignment="start">
            <font face="helvetica" size="10"/>
            <geometryInfo x="1.87500" y="0.18750" width="1.50000"
             height="0.18750"/>
            <generalLayout verticalElasticity="expand"/>
          </field>
          <field name="F_E_MGR" source="E_MGR" minWidowLines="1" spacing="0"
           alignment="start">
            <font face="helvetica" size="10"/>
          ...
          <field name="F_E_SALARY" source="E_SALARY" minWidowLines="1"
           spacing="0" alignment="start">
            <font face="helvetica" size="10"/>
            <geometryInfo x="5.18750" y="0.18750" width="0.56250"
             height="0.18750"/>
            <generalLayout verticalElasticity="expand"/>
          </field>
          <field name="F_DEPT_NO" source="DEPT_NO" minWidowLines="1"
           spacing="0" alignment="start">
            <font face="helvetica" size="10"/>
            <geometryInfo x="5.75000" y="0.18750" width="0.56250"
             height="0.18750"/>
            <generalLayout verticalElasticity="expand"/>
          </field>
        </repeatingFrame>
        <frame name="M_G_E_NO_FTR">
          ...
          <field name="F_SumE_SALARYPerReport" source="SumE_SALARYPerReport"
           minWidowLines="1" spacing="0" alignment="start">
            <font face="helvetica" size="10" bold="yes"/>
            <geometryInfo x="5.18750" y="0.37500" width="0.56250"
             height="0.18750"/>
            <generalLayout verticalElasticity="expand"/>
          </field>
        ...
        <frame name="M_G_E_NO_HDR">
          ...
          <text name="B_E_NO" minWidowLines="1">
            <textSettings spacing="0"/>
          ...
          <text name="B_E_NAME" minWidowLines="1">
            <textSettings spacing="0"/>
            <geometryInfo x="0.37500" y="0.00000" width="1.50000"
             height="0.18750"/>
          ...
          <text name="B_E_JOB" minWidowLines="1">
            <textSettings spacing="0"/>
            <geometryInfo x="1.87500" y="0.00000" width="1.50000"
             height="0.18750"/>
            <visualSettings fillBackgroundColor="r25g50b75"/>
            <textSegment>
              <font face="helvetica" size="10" bold="yes"
          ...
          <text name="B_E_MGR" minWidowLines="1">
            <textSettings spacing="0"/>
          ...
          <text name="B_E_SALARY" minWidowLines="1">
            <textSettings spacing="0"/>
            <geometryInfo x="5.18750" y="0.00000" width="0.56250"
             height="0.18750"/>
            <visualSettings fillBackgroundColor="TableHeading"/>
            <textSegment>
              <font face="helvetica" size="10" bold="yes"
          ...
          <text name="B_DEPT_NO" minWidowLines="1">
            <textSettings spacing="0"/>
...
<rw:dataArea id="MGENOGRPFR106">
<table class="OraTable">
<caption>  </caption>
 <!-- Header -->
 <thead>
  <tr>
   <th <rw:id id="HBENO106" asArray="no"/> class="OraColumnHeader"> E No </th>
   <th <rw:id id="HBENAME106" asArray="no"/> class="OraColumnHeader"> E Name </th>
   <th <rw:id id="HBEJOB106" asArray="no"/> class="OraColumnHeader"> E Job </th>
   <th <rw:id id="HBEMGR106" asArray="no"/> class="OraColumnHeader"> E Mgr </th>
   <th <rw:id id="HBHIREDATE106" asArray="no"/> class="OraColumnHeader"> Hiredate </th>
   <th <rw:id id="HBESALARY106" asArray="no"/> class="OraColumnHeader"> E Salary </th>
   <th <rw:id id="HBDEPTNO106" asArray="no"/> class="OraColumnHeader"> Dept No </th>
  </tr>
 </thead>
 <!-- Body -->
 <tbody>
  <rw:foreach id="RGENO1061" src="G_E_NO">
   <tr>
    <td <rw:headers id="HFENO106" src="HBENO106"/> class="OraCellNumber"><rw:field id="FENO106" src="E_NO" nullValue="&nbsp;"> F_E_NO </rw:field></td>
    <td <rw:headers id="HFENAME106" src="HBENAME106"/> class="OraCellText"><rw:field id="FENAME106" src="E_NAME" nullValue="&nbsp;"> F_E_NAME </rw:field></td>
    <td <rw:headers id="HFEJOB106" src="HBEJOB106"/> class="OraCellText"><rw:field id="FEJOB106" src="E_JOB" nullValue="&nbsp;"> F_E_JOB </rw:field></td>
    <td <rw:headers id="HFEMGR106" src="HBEMGR106"/> class="OraCellNumber"><rw:field id="FEMGR106" src="E_MGR" nullValue="&nbsp;"> F_E_MGR </rw:field></td>
    <td <rw:headers id="HFHIREDATE106" src="HBHIREDATE106"/> class="OraCellText"><rw:field id="FHIREDATE106" src="HIREDATE" nullValue="&nbsp;"> F_HIREDATE </rw:field></td>
    <td <rw:headers id="HFESALARY106" src="HBESALARY106"/> class="OraCellNumber"><rw:field id="FESALARY106" src="E_SALARY" nullValue="&nbsp;"> F_E_SALARY </rw:field></td>
    <td <rw:headers id="HFDEPTNO106" src="HBDEPTNO106"/> class="OraCellNumber"><rw:field id="FDEPTNO106" src="DEPT_NO" nullValue="&nbsp;"> F_DEPT_NO </rw:field></td>
   </tr>
  </rw:foreach>
 </tbody>
 ...
 <tr>
  ...
  <th class="OraTotalText"> &nbsp; </th>
  <th class="OraTotalText"> &nbsp; </th>
  <td <rw:headers id="HFSumESALARYPerReport106" src="HBESALARY106"/> class="OraTotalNumber">Total: <rw:field id="FSumESALARYPerReport106" src="SumE_SALARYPerReport" nullValue="&nbsp;"> F_SumE_SALARYPerReport </rw:field></td>
  <th class="OraTotalText"> &nbsp; </th>
 </tr>
</table>
</rw:dataArea> <!-- id="MGENOGRPFR106" -->
